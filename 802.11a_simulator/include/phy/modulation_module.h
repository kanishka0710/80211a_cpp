...
namespace wifi80211a
{
    ...
    private:
        ...
        // BPSK — K_MOD = 1
        static inline const std::map<int, std::complex<double>> bpsk_map = {
            {0, {-1.0,  0.0}},
            {1, { 1.0,  0.0}},
        };
        ...
        static inline const std::map<int, std::complex<double>> qpsk_map = {
        ...
        static inline const std::map<int, std::complex<double>> qam16_map = {
        ...
        static inline const std::map<int, std::complex<double>> qam64_map = {
